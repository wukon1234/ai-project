...
class DocumentAiServiceTest {
    ...
    void shouldBuildShortExtractiveSummary() {
        DocumentAiService service = new DocumentAiService(
                Mockito.mock(com.zhishiyun.kb.document.DocumentService.class),
                Mockito.mock(com.zhishiyun.kb.infra.mysql.mapper.KbChunkMapper.class),
                Mockito.mock(com.zhishiyun.kb.infra.mysql.mapper.KbLibraryMapper.class),
                Mockito.mock(com.zhishiyun.kb.rag.VectorSearchService.class),
